        ...
        <div className="post-text">
          ...
          <div className="post-social">
              ...
              <h3 className="post-author">
                <Link to={`/@${post.user.username}`} className="post-author">
                  <img
                    ...
                    alt="article cover"/> {post.user.name || post.user.username}
                </Link>
              </h3>
            </span>
            ...
            <span style={{
              ...
              <Link target="_blank" to={`https://twitter.com/${post.user.twitter_username}`}>
                <Icon
                  type="twitter"
                  style={{
                  color: '#666'
            ...
            <span style={{
              ...
              <Link target="_blank" to={`https://github.com/${post.user.github_username}`}>
                <Icon
                  type="github"
                  style={{
                  color: '#666'
          ...
          <div className="post-likes">
            <span onClick={likePost}>
              <Icon type="heart" style={{
                color: '#f5222d'
              }}/>{' '}
            </span>
            <span onClick={this.showModal}>{post.likes.length}
              likes</span>
          </div>
        </div>
      </div>
